...
data_root = '/media/tsinghua3090/66c73fca-acad-4d88-a5b9-47aa246d1d02/THUD_Robot-mmdetection-multimodal/'
backend_args = None
classes = ('airconditioner','Bag','Basket','Bench','Board','Book','Bottle','Box','Chair','Checkout','Computer','Cup','Door','FireExtinguisher','Freezer','Fridge','Fruits','Glass','Lamp','Laptop','Lift','Microwave oven','Mirror','People','Plants','Products','Robot','Shelf','Shopping Cart','Sign','Sofa','Spotlight','Stairs','Stall','Stool','Table','Tea table','Trashcan','TV','Vent','Wash Basin','Window')
train_pipeline = [
